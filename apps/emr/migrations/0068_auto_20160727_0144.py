    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('finding', models.CharField(default=b'fecal occult blood test', max_length=100, choices=[(b'fecal occult blood test', b'Fecal occult blood test'), (b'colonoscopy', b'Colonoscopy'), (b'fecal immunochemical test', b'Fecal immunochemical test'), (b'other', b'Other')])),
        ...
        migrations.AddField(
            ...
            name='report_images',
            field=models.ManyToManyField(related_name='report_images_studies', to='emr.ColonCancerStudyImage', blank=True),
        ),
    ]
