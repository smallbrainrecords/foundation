    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(related_name='author_studies', to='emr.UserProfile', on_delete=models.CASCADE)),
                ('colon', models.ForeignKey(related_name='colon_studies', to='emr.ColonCancerScreening', on_delete=models.CASCADE)),
                (
                'last_updated_user', models.ForeignKey(related_name='last_updated_user_studies', to='emr.UserProfile', on_delete=models.CASCADE)),
            ],
            options={
                'ordering': ['-created_on'],
            },
