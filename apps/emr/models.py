...
class PatientController(models.Model):
    patient = models.ForeignKey(User, related_name='patient_physicians', on_delete=models.CASCADE)
    physician = models.ForeignKey(User, related_name='physician_patients', on_delete=models.CASCADE)
    author = models.BooleanField(default=False)


class PhysicianTeam(models.Model):
    # Need to add  save_admin to check if member is physician
    physician = models.ForeignKey(User, related_name='physician_helpers', on_delete=models.CASCADE)
    member = models.ForeignKey(User, related_name='user_leaders', on_delete=models.CASCADE)
...
class Encounter(models.Model):
    physician = models.ForeignKey(User, related_name="physician_encounters", on_delete=models.CASCADE)
    patient = models.ForeignKey(User, related_name="patient_encounters", on_delete=models.CASCADE)
...
class ProblemLabel(models.Model):
    ...
    author = models.ForeignKey(User, null=True, blank=True, related_name="problem_label_author", on_delete=models.SET_NULL)
    patient = models.ForeignKey(User, null=True, blank=True, related_name="problem_label_patient", on_delete=models.SET_NULL)
...
class Problem(MPTTModel):
    ...
    icd10_code = models.CharField(max_length=15, blank=True, null=True)
...
class SharingPatient(models.Model):
    sharing = models.ForeignKey(User, related_name='patient_sharing', on_delete=models.CASCADE)
    shared = models.ForeignKey(User, related_name='patient_shared', on_delete=models.CASCADE)
...
class ProblemOrder(models.Model):
    patient = models.ForeignKey(User, null=True, blank=True, related_name="patient_problem_order", on_delete=models.SET_NULL)
    user = models.ForeignKey(User, null=True, blank=True, related_name="user_problem_order", on_delete=models.SET_NULL)
...
class ProblemSegment(models.Model):
    problem = models.ForeignKey(Problem, related_name='problem_segment', on_delete=models.CASCADE)
    is_controlled = models.BooleanField(default=False)
    is_active = models.BooleanField(default=True)
    authenticated = models.BooleanField(default=False)
...
class LabeledProblemList(models.Model):
    user = models.ForeignKey(User, null=True, blank=True, related_name="label_problem_list_user", on_delete=models.SET_NULL)
    patient = models.ForeignKey(User, null=True, blank=True, related_name="label_problem_list_patient", on_delete=models.SET_NULL)
    labels = models.ManyToManyField(ProblemLabel, blank=True)
...
class ToDo(models.Model):
    ...
    user = models.ForeignKey(User, null=True, blank=True, related_name="todo_owner", on_delete=models.SET_NULL)  # Author
    patient = models.ForeignKey(User, null=True, blank=True, related_name="todo_patient", on_delete=models.SET_NULL)
    labels = models.ManyToManyField(Label, blank=True)
    a1c = models.ForeignKey("AOneC", null=True, blank=True, related_name="a1c_todos", on_delete=models.SET_NULL)
    problem = models.ForeignKey(Problem, null=True, blank=True, on_delete=models.SET_NULL)
    colon_cancer = models.ForeignKey("ColonCancerScreening", null=True, blank=True, related_name="colon_cancer_todos", on_delete=models.SET_NULL)
...
class TaggedToDoOrder(models.Model):
    ...
    todo = models.ForeignKey(ToDo, null=True, blank=True, on_delete=models.SET_NULL)
...
class GuidelineForm(models.Model):
    guideline = models.OneToOneField(Guideline, on_delete=models.CASCADE)
...
class Sharing(models.Model):
    patient = models.ForeignKey(User, related_name='target_patient', on_delete=models.CASCADE)
    other_patient = models.ForeignKey(User, related_name='other_patient', on_delete=models.CASCADE)
...
class Viewer(models.Model):
    patient = models.ForeignKey(User, related_name='viewed_patient', on_delete=models.CASCADE)
...
class ProblemRelationship(models.Model):
    source = models.ForeignKey(Problem, related_name="source", on_delete=models.CASCADE)
    target = models.ForeignKey(Problem, related_name="target", on_delete=models.CASCADE)
...
class TodoActivity(models.Model):
    ...
    author = models.ForeignKey(User, null=True, blank=True, on_delete=models.SET_NULL)
    comment = models.ForeignKey(ToDoComment, null=True, blank=True, on_delete=models.SET_NULL)
    attachment = models.ForeignKey(ToDoAttachment, null=True, blank=True, on_delete=models.SET_NULL)
    activity = models.TextField()
    created_on = models.DateTimeField(auto_now_add=True)
...
class Observation(models.Model):
    ...
    subject = models.ForeignKey(User, null=True, blank=True, related_name='observation_subjects', on_delete=models.SET_NULL)
    # TODO: Check for deprecation
    encounter = models.ForeignKey(User, null=True, blank=True, related_name='observation_encounters', on_delete=models.SET_NULL)
    # TODO: Check for deprecation
...
class ObservationComponent(models.Model):
    ...
    observation = models.ForeignKey(Observation, related_name='observation_components', on_delete=models.CASCADE)
    author = models.ForeignKey(User, null=True, blank=True, related_name='observation_component_authors', on_delete=models.SET_NULL)
...
class ObservationUnit(models.Model):
    observation = models.ForeignKey(Observation, related_name='observation_units', on_delete=models.CASCADE)
    value_unit = models.CharField(max_length=45, null=True, blank=True)
...
class ObservationOrder(models.Model):
    patient = models.ForeignKey(User, null=True, blank=True, related_name="patient_observation_order", on_delete=models.SET_NULL)
    user = models.ForeignKey(User, null=True, blank=True, related_name="user_observation_order", on_delete=models.SET_NULL)
    order = ListField(null=True, blank=True)
...
class ObservationPinToProblem(models.Model):
    author = models.ForeignKey(User, null=True, blank=True, related_name='pin_authors', on_delete=models.SET_NULL)
    observation = models.ForeignKey(Observation, null=True, blank=True, related_name='pin_observations', on_delete=models.SET_NULL)
...
class State(models.Model):
    country = models.ForeignKey(Country, related_name='country_states', on_delete=models.CASCADE)
...
class Address(models.Model):
    ...
    city = models.ForeignKey(City, related_name='city_addresses', on_delete=models.CASCADE)
...
class UserTelecom(models.Model):
    user = models.ForeignKey(User, related_name='user_telecoms', on_delete=models.CASCADE)
    telecom = models.ForeignKey(Telecom, related_name='telecom_users', on_delete=models.CASCADE)
...
class UserAddress(models.Model):
    ...
    address = models.ForeignKey(Address, related_name='address_users', on_delete=models.CASCADE)
    type_code = models.ForeignKey(AddressType, related_name='type_code_user_address', on_delete=models.CASCADE)
    use_code = models.ForeignKey(AddressUse, related_name='use_code_user_address', on_delete=models.CASCADE)
    start = models.DateTimeField(null=True, blank=True)
    end = models.DateTimeField(null=True, blank=True)


class AOneC(models.Model):
    problem = models.OneToOneField(Problem, related_name='problem_aonecs', on_delete=models.CASCADE)
    todo_past_six_months = models.BooleanField(default=False)
    patient_refused_A1C = models.BooleanField(default=False)
    observation = models.OneToOneField(Observation, related_name='observation_aonecs', on_delete=models.CASCADE)
...
class AOneCTextNote(models.Model):
    note = models.TextField()
    a1c = models.ForeignKey(AOneC, related_name='a1c_notes', on_delete=models.CASCADE)
    author = models.ForeignKey(User, null=True, blank=True, on_delete=models.SET_NULL)
...
class ObservationValueTextNote(models.Model):
    note = models.TextField()
    observation_value = models.ForeignKey(ObservationValue, related_name='observation_value_notes', on_delete=models.CASCADE)
    author = models.ForeignKey(User, null=True, blank=True, on_delete=models.SET_NULL)
...
class CommonProblem(models.Model):
    ...
    author = models.ForeignKey(User, null=True, blank=True, related_name="common_problem_author", on_delete=models.SET_NULL)
...
class ColonCancerScreening(models.Model):
    ...
    problem = models.ForeignKey(Problem, related_name='problem_colon_cancer', on_delete=models.CASCADE)
    patient = models.ForeignKey(User, related_name='patient_colon_cancer', on_delete=models.CASCADE)
...
class ColonCancerStudy(models.Model):
    ...
    colon = models.ForeignKey(ColonCancerScreening, related_name='colon_studies', on_delete=models.CASCADE)
    author = models.ForeignKey(User, related_name='author_studies', on_delete=models.CASCADE)
    last_updated_user = models.ForeignKey(User, related_name='last_updated_user_studies', null=True, blank=True, on_delete=models.SET_NULL)
...
class ColonCancerStudyImage(models.Model):
    ...
    author = models.ForeignKey(User, null=True, blank=True, on_delete=models.SET_NULL)
    study = models.ForeignKey(ColonCancerStudy, null=True, blank=True, related_name="study_images", on_delete=models.SET_NULL)
...
class RiskFactor(models.Model):
    colon = models.ForeignKey(ColonCancerScreening, related_name='colon_risk_factors', on_delete=models.CASCADE)
    factor = models.CharField(max_length=100, null=True, blank=True)


class ColonCancerTextNote(models.Model):
    note = models.TextField()
    colon = models.ForeignKey(ColonCancerScreening, related_name='colon_notes', on_delete=models.CASCADE)
    author = models.ForeignKey(User, null=True, blank=True, on_delete=models.SET_NULL)
...
class MyStoryTab(models.Model):
    ...
    patient = models.ForeignKey(User, related_name="patient_story_tabs", on_delete=models.CASCADE)
...
class MyStoryTextComponent(models.Model):
    ...
    is_all = models.BooleanField(default=False)
    tab = models.ForeignKey(MyStoryTab, null=True, blank=True, related_name="my_story_tab_components", on_delete=models.SET_NULL)
    patient = models.ForeignKey(User, related_name="patient_story_texts", on_delete=models.CASCADE)
    author = models.ForeignKey(User, related_name="author_story_texts", null=True, blank=True, on_delete=models.SET_NULL)
...
class MyStoryTextComponentEntry(models.Model):
    ...
    component = models.ForeignKey(MyStoryTextComponent, null=True, blank=True, related_name="text_component_entries", on_delete=models.SET_NULL)
    patient = models.ForeignKey(User, related_name="patient_story_text_entries", null=True, blank=True, on_delete=models.SET_NULL)
    author = models.ForeignKey(User, related_name="author_story_text_entries", null=True, blank=True, on_delete=models.SET_NULL)
...
class Inr(models.Model):
    ...
    observation_value = models.OneToOneField(ObservationValue, related_name="inr", null=True, on_delete=models.SET_NULL)

    # Medication dosage author
    author = models.ForeignKey(User, related_name='author_inr', blank=True, null=True, on_delete=models.SET_NULL)
    # Can be in duplication with patient in observation value becuz this in one-2-on relationship
    patient = models.ForeignKey(User, related_name="patient_inr", null=True, on_delete=models.SET_NULL)
...
class InrTextNote(models.Model):
    note = models.TextField()
    author = models.ForeignKey(User, related_name="author_note", on_delete=models.CASCADE)
    patient = models.ForeignKey(User, related_name="patient_note", on_delete=models.CASCADE)
...
class Medication(models.Model):
    ...
    author = models.ForeignKey(User, related_name='author_medications', on_delete=models.CASCADE)
    patient = models.ForeignKey(User, related_name="patient_medications", blank=True, null=True, on_delete=models.SET_NULL)
    created_on = models.DateTimeField(auto_now_add=True)
...
class MedicationPinToProblem(models.Model):
    author = models.ForeignKey(User, null=True, blank=True, related_name='author_pin_medications', on_delete=models.SET_NULL)
    medication = models.ForeignKey(Medication, related_name='medication_pin_medications', on_delete=models.CASCADE)
    problem = models.ForeignKey(Problem, related_name='problem_pin_medications', on_delete=models.CASCADE)


class MedicationTextNote(models.Model):
    note = models.TextField()
    medication = models.ForeignKey(Medication, related_name='medication_notes', on_delete=models.CASCADE)
...
class Document(models.Model):
    ...
    author = models.ForeignKey(User, related_name='author_document', on_delete=models.CASCADE)
    ...
    def file_mime_type(self):
        mime, _ = mimetypes.guess_type(self.document.name)
        return mime or ''
...
class DocumentTodo(models.Model):
    ...
    todo = models.ForeignKey(ToDo, on_delete=models.CASCADE)
    author = models.ForeignKey(User, on_delete=models.CASCADE)  # User who attach document to the todo
    created_on = models.DateTimeField(auto_now_add=True)
...
class DocumentProblem(models.Model):
    ...
    author = models.ForeignKey(User, on_delete=models.CASCADE)  # User who attach document to the problem
    created_on = models.DateTimeField(auto_now_add=True)
...
class EncounterObservationValue(models.Model):
    encounter = models.ForeignKey(Encounter, null=False, on_delete=models.CASCADE)
    observation_value = models.ForeignKey(ObservationValue, null=False, on_delete=models.CASCADE)
    created_on = models.DateTimeField(auto_now_add=True)
...
class Narrative(models.Model):
    ...
    patient = models.ForeignKey(User, related_name="patient_narratives", on_delete=models.CASCADE)
    author = models.ForeignKey(User, related_name="owned_narratives", on_delete=models.CASCADE)
    parent = models.ForeignKey("Narrative", related_name="child", null=True, on_delete=models.SET_NULL)
...
class EncounterMedication(models.Model):
    encounter = models.ForeignKey(to=Encounter, related_name='medications', on_delete=models.CASCADE)
    medication = models.ForeignKey(to=Medication, related_name='encounters', on_delete=models.CASCADE)
    created_at = models.DateTimeField(auto_now_add=True)
...
def sync_encounter_to_openemr(sender, instance, created, **kwargs):
    ...
    if not instance.is_active() and instance.stoptime:
        try:
            from .fhir_client import OpenEMRFHIRClient
            client = OpenEMRFHIRClient()
            # Assuming 1:1 internal PK to FHIR ID mapping for the shared project
            client.sync_encounter(
                patient_fhir_id=instance.patient.id,
                status='finished',
                encounter_class='AMB', # default ambulatory
                start_time=instance.starttime.isoformat()
            )
        except Exception as e:
            import logging
            logging.getLogger(__name__).error("FHIR Encounter Sync Failed", exc_info=True)

class SnomedConcept(models.Model):
    concept_id = models.CharField(max_length=18, primary_key=True)
    active = models.BooleanField(default=True)

class SnomedRelationship(models.Model):
    id = models.CharField(max_length=18, primary_key=True)
    active = models.BooleanField(default=True)
    source = models.ForeignKey(SnomedConcept, on_delete=models.CASCADE, related_name='outgoing_relationships')
    destination = models.ForeignKey(SnomedConcept, on_delete=models.CASCADE, related_name='incoming_relationships')
    type_id = models.CharField(max_length=18)


class SnomedIcd10Map(models.Model):
    snomed_concept_id = models.CharField(max_length=18, db_index=True)
