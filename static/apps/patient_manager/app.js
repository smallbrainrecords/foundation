(function () {
    ...
    ManagerApp.run(function (CollapseService, sharedService, $templateCache) {
        ...
        $templateCache.put('bleedingRiskDialog', "<div class='text-center'><p>This patient is on Warfarin, will this affect the patient's bleeding risk?</p><button class='btn btn-primary' ng-click='closeThisDialog()'>Thank you</button></div>");
        ...
        $templateCache.put('todoPopupConfirmDialog', "<button class='btn btn-primary btn-block' ng-click='closeThisDialog(true)'>Yes, mark this todo as accomplished?</button> <button class='btn btn-danger btn-block' ng-click='closeThisDialog()'>No, don't mark this todo as accomplished</button>");
    });
