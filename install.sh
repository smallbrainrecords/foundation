...
sudo pip install django django-mptt django-reversion django-social_auth django-genericadmin python-mysqldb
git clone https://github.com/smallbrainrecords/foundation.git
read -p "Enter your root db password " dbpassword
