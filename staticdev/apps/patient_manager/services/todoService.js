(function () {
    ...
    angular.module('ManagerApp').service('todoService',
        function ($http, $q, $cookies, httpService) {
             ...
             * @return {*}
             */
            this.createToDoGroup = function (form, patient_id) {
                var url = '/todo/patient/' + patient_id + '/todogroup/create_todo_group';
                return httpService.post(form, url);
            };


            /**
             * Add an existing to do to existing todo_group
             * @param form
             * @param todo_id
             * @return {*}
             */
            this.addToDoToGroup = function (form) {
                var url = '/todo/todo/updateGroup';
                return httpService.post(form, url);
            };
             ...
             * @return {*}
             */
            this.removeToDoGroup = function (form) {
                var url = '/todo/todo/updateGroup';
                return httpService.post(form, url);
            };

            /**
             * Update todo_group information
             * @param form
             */
            this.updateToDoGroup = function (form, group_id) {
                var url = '/todo/todoGroup/' + group_id + '/update_todo_group';
                return httpService.post(form, url);
            };

            /**
             * Delete an todo_group item
             * @param form
             * @param group_id
             * @return {*}
             */
            this.deleteToDoGroup = function (form, group_id) {
                var url = '/todo/todoGroup/' + group_id + '/delete';
                return httpService.post(form, url);
            };
        });
